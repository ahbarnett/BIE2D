...
% STOSLPMAT   Matrices for Stokes single-layer velocity, pressure, and traction.
%
% [A,P,T] = StoSLPmat(t,s,mu) returns dense matrices taking single-layer
